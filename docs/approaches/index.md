...
This work has been supported by the Estonian Research Council (PRG1634: Model-based Learning Analytics for Fostering Students' Higher-order Thinking Skills) and the European Commission (Efficiency and Effectiveness of Training for Teachers' Pedagogical Digital Competence).
...
This research direction is supported by the European Commission project Teacher-AI Complementarity (2025–2028) and connects to our broader interest in how training interventions can prepare teachers for effective collaboration with intelligent learning technologies.

</div>
</div>

<div class="lab-approach" markdown>
<div class="lab-approach-id">FLP</div>
<div class="lab-approach-body" markdown>
...
This work builds on the Ministry of Education funded project on flexible learning paths (2021–2024) and the ongoing EduFlexit project developing smart learning analytics platforms for schools.
...
### Co-Creation & Multi-Stakeholder Partnerships

Educational technology succeeds or fails at the point of adoption. Our research takes an activity system perspective on how school–university–industry partnerships can co-create learning technologies and scale educational innovations. We study the social practices, trust-building mechanisms, and value creation processes that make multi-stakeholder networks effective.

Practically, this means our tools are developed with teachers, not for them. The ICAP Lesson Plan Toolbox was shaped by teacher educators and mentors who needed structured reflection workflows. The Curriculum Manager emerged from collaboration with curriculum specialists at the Estonian Ministry of Education. The Diffusion Simulation Game was adapted from its original board game form through co-design with instructors teaching change management.

We have coordinated and participated in multiple European co-creation networks (Erasmus+ projects on scaling educational innovation, digital innovation hubs, STEAM education clusters) and study how these partnerships translate into sustainable adoption of research-based tools in schools.

</div>
</div>

<div class="lab-approach" markdown>
<div class="lab-approach-id">DCA</div>
<div class="lab-approach-body" markdown>
